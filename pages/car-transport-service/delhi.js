...
export default function CarTransportService() {
    ...
    return (
        <>
            <NextSeo
                title="Car And Vehicle Transportation Service in Delhi"
                ...
                canonical={`${LOCALISATION_DATA[locale].domain}/car-transport-service/delhi`}
                openGraph={{
                    url: `${LOCALISATION_DATA[locale].domain}/car-transport-service/delhi`,
                    title: 'Car And Vehicle Transportation Service in Delhi',
                    description: 'We at Autoave take pride in our services. We are a team of highly qualified and experienced car and vehicle movers. We are here to help you with your car and vehicle transportation needs.',
                    images: [
                        {
                ...
                additionalMetaTags={[{
                    name: 'keywords',
                    content: 'Car transport in delhi, vehicle transport in delhi, bike transport in delhi, car shifting'
                }]}
            />
            ...
            <LocalBusinessJsonLd
                ...
                description="Best Car Transportation Service in Delhi"
                url="https://transport.autoave.in/car-transport-service/delhi"
                            ...
                            <div className="py-12 px-4 lg:py-32 mx-auto text-center">
                                <div className="mb-8">
                                    <h1 className="text-shadow text-3xl lg:text-5xl font-bold tracking-tighter mb-2 text-white">
                                        Best Car Transport Services across in Delhi
                                    </h1>
