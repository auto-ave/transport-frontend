    ...
    return (
        <>
            <NextSeo
                ...
                description="Privacy Policy for Consumers at Autoave - Simplifying the way you take care of your car."
                canonical={`${LOCALISATION_DATA[locale].domain}/consumer/privacy-policy`}
                openGraph={{
                    url: `${LOCALISATION_DATA[locale].domain}/consumer/privacy-policy`,
            ...
            <div className="container p-3 py-40">
                ...
                <p> Autoave (“we,” “our,” or “us”) is committed to protecting your privacy. This Privacy Policy explains how your personal information is collected, used, and disclosed by Autoave.</p>
                <p>This Privacy Policy applies to our website, and its associated subdomains (collectively, our “Service”) alongside our application, Autoave. By accessing or using our Service, you signify that you have read, understood, and agree to our collection, storage, use, and disclosure of your personal information as described in this Privacy Policy and our Terms of Service.</p>
                ...
                <p>To help explain things as clearly as possible in this Privacy Policy, every time any of these terms are referenced, are strictly defined as:
                    <ul>
                        ...
                        <li>Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to AUTOAVE PRIVATE LIMITED, No-42 ,4th Main, NGEF Layout, Postal Colony, Sanjaynagar,  Bangalore, Karnataka-560094 that is responsible for your information under this Privacy Policy.</li>
                        <li>Country: where Autoave or the owners/founders of Autoave are based, in this case is {LOCALISATION_DATA[locale].country}</li>
                        <li>Customer: refers to the company, organization or person that signs up to use the Autoave Service to manage the relationships with your consumers or service users.</li>
                        ...
                        <li>Personnel: refers to those individuals who are employed by Autoave or are under contract to perform a service on behalf of one of the parties.</li>
                ...
                <h1>When does Autoave use end user information from third parties?</h1>
                <p>Autoave will collect End User Data necessary to provide the Autoave services to our customers.</p>
                ...
                <h1>When does Autoave use customer information from third parties?</h1>
                <p>We receive some information from the third parties when you contact us. For example, when you submit your email address to us to show interest in becoming a Autoave customer, we receive information from a third party that provides automated fraud detection services to Autoave. We also occasionally collect information that is made publicly available on social media websites. You can control how much of your information social media websites make public by visiting these websites and changing your privacy settings.</p>
                ...
                <p>Autoave will collect personal information that you submit to us. We may also receive personal information about you from third parties as described above.</p>
                ...
                <p>The rights you have to request updates or corrections to the information Autoave collects depend on your relationship with Autoave. Personnel may update or correct their information as detailed in our internal company employment policies.</p>
                ...
                <h1>Personnel</h1>
                <p>If you are a Autoave worker or applicant, we collect information you voluntarily provide to us. We use the information collected for Human Resources purposes in order to administer benefits to workers and screen applicants.</p>
                ...
                <p>We reserve the right to transfer information to a third party in the event of a sale, merger or other transfer of all or substantially all of the assets of Autoave or any of its Corporate Affiliates (as defined herein), or that portion of Autoave or any of its Corporate Affiliates to which the Service relates, or in the event that we discontinue our business or file a petition or have filed against us a petition in bankruptcy, reorganization or similar proceeding, provided that the third party agrees to adhere to the terms of this Privacy Policy.</p>

                <h1>Affiliates</h1>
                <p>We may disclose information (including personal information) about you to our Corporate Affiliates. For purposes of this Privacy Policy, &apos;Corporate Affiliate&apos; means any person or entity which directly or indirectly controls, is controlled by or is under common control with Autoave, whether by ownership or otherwise. Any information relating to you that we provide to our Corporate Affiliates will be treated by those Corporate Affiliates in accordance with the terms of this Privacy Policy.</p>

                <h1>Governing Law</h1>
                <p>This Privacy Policy is governed by the laws of {LOCALISATION_DATA[locale].country} without regard to its conflict of laws provision. You consent to the exclusive jurisdiction of the courts in connection with any action or dispute arising between the parties under or in connection with this Privacy Policy except for those individuals who may have rights to make claims under Privacy Shield, or the Swiss-US framework.</p>
                <p>The laws of {LOCALISATION_DATA[locale].country}, excluding its conflicts of law rules, shall govern this Agreement and your use of the website/app. Your use of the website/app may also be subject to other local, state, national, or international laws.</p>
                <p>By using Autoave or contacting us directly, you signify your acceptance of this Privacy Policy. If you do not agree to this Privacy Policy, you should not engage with our website, or use our services. Continued use of the website, direct engagement with us, or following the posting of changes to this Privacy Policy that do not significantly affect the use or disclosure of your personal information will mean that you accept those changes.</p>
